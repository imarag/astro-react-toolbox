export default function Accordion({ label = "my accordion", initialOpen = false, accordionRadioName = "accordion", accordionIcon = "arrow", className, children }) {
    const baseClass = "collapse bg-base-100 border border-base-300";
    ...
    return (
        <div className={globalClass}>
            {
                initialOpen ? (
                    <input type="checkbox" name={accordionRadioName} defaultChecked />
                ) : (
                    <input type="checkbox" name={accordionRadioName} />
                )
            }
